...
const ProductDetail = () => {
  ...
  const primaryImage = product.image_objects?.find(img => img.is_primary)?.image_url || 
                      product.images?.[0] || 
                      'https://via.placeholder.com/600x600?text=No+Image'

  // Get all images for gallery
  const productImages = product.images?.length > 0 ? product.images : [primaryImage]
              ...
              <div className="border-t pt-4">
                <div className="grid grid-cols-2 gap-4 text-sm text-gray-600">
                  <div>
                    ...
                    <span className="ml-2 capitalize">{product.category_name || product.category}</span>
                  </div>
                  <div>
